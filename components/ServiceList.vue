  ...
  <Container>
    <div id="home" class="service-list">
      ...
      <div class="projects-link-grid">
        <NuxtLink
          :class="{ 'active': hover && hover === 'projects', hover: hover, 'projects-link projects-link-grid': true }"
...
.service-list {
  ...
  height: $main-height;
  .service-link:nth-child(3n+1) { order: 1; }
  .service-link:nth-child(3n+2) { order: 2; }
  .service-link:nth-child(3n)   { order: 3; }
  #Design.service-link {
    // order: 1;
    width: 32%;
    height: auto;
